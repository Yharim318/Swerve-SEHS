...
public class RightPiece extends ParallelCommandGroup {
  /** Creates a new MiddlePiece. */
  public RightPiece(Swerve s_Swerve, Intake cIntake, Shooter cShooter, SillyGuy cSillyGuy) {
    ...
    addCommands(
            new SequentialCommandGroup(
              new exampleAuto(s_Swerve, List.of(
                ...
                new Pose2d(0, -1.4, Rotation2d.fromDegrees(0)), 
                new Pose2d(0, 0.7, Rotation2d.fromDegrees(0))
              )),
              s_Swerve.run(() -> {
